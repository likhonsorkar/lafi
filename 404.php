...
<div class="d-flex align-items-center justify-content-center vh-100">
    <div class="text-center">
      <a href="<?php echo esc_url(home_url()); ?>" class="chairsochar">
        <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-house-slash-fill" viewBox="0 0 16 16">
